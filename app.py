        ...
        while True:
            ...
            if audio_np.size > 0:
                ...
                with console.status("Generating response...", spinner="dots"):
                    ...
                    # Auto-scale TTS steps with response length to avoid cut-off audio.
                    # You can override with --tts-steps N (try 200-400).
                    ...
                    # Generate audio once per response (much faster than sentence-by-sentence long form)
